...
st.markdown(
    """
    <style>
    @import url(\'https://fonts.googleapis.com/css2?family=Be+Vietnam+Pro:wght@300;400;500;600;700;800;900&family=Sora:wght@600;700;800&display=swap\');
    .stApp {
        background: linear-gradient(160deg, #FFFDF7 0%, #F0FBF4 55%, #FFF6F0 100%);
        color: #1A2E22;
        font-family: \'Be Vietnam Pro\', sans-serif;
    }
    [data-testid="stSidebar"] {
        background: linear-gradient(180deg, #0F2E4A 0%, #163E5C 100%);
        border-right: none;
    }
    h1, h2, h3, h4, h5 {
    ...
    p, li, label, span, div { font-family: \'Be Vietnam Pro\', sans-serif; }

    /* ===== Hero — bo cuc 2 cot: huy hieu + noi dung ===== */
    .hero {
        position: relative;
        display: flex;
        align-items: center;
        ...
        background: linear-gradient(125deg, #0F2E4A 0%, #1B4F72 60%, #163E5C 100%);
        box-shadow: 0 14px 40px rgba(15,46,74,0.28);
        margin-bottom: 22px;
        overflow: hidden;
        isolation: isolate;
    }
    ...
    @media (max-width: 720px) {
        ...
        .hero-emblem { width: 58px; height: 58px; font-size: 26px; }
    }

    /* ===== Section heading — khoi the dam mau, bo tron 1 ben ===== */
    .section-heading {
        display: flex;
        align-items: center;
        gap: 12px;
        ...
        background: linear-gradient(90deg, #0F2E4A 0%, #1B4F72 100%);
        box-shadow: 0 4px 14px rgba(15,46,74,0.18);
    }
    .section-heading .num {
        font-family: \'Sora\', sans-serif;
        font-size: 13px;
    ...
    /* ===== Card chung — bo tron khong deu, vien xanh nhat ===== */
    .section-card {
        position: relative;
        padding: 22px 24px;
        ...
        box-shadow: 0 6px 24px rgba(15,46,74,0.07);
        margin-bottom: 18px;
        overflow: hidden;
    }
    .section-card::after {
        ...
        height: 90px;
        border-radius: 50%;
        background: radial-gradient(circle, rgba(255,205,0,0.12), transparent 70%);
        pointer-events: none;
    }

    /* ===== KPI card — bo cuc ngang: chi so + noi dung ===== */
    .kpi-card {
        position: relative;
        display: flex;
        align-items: center;
        ...
        border: 1px solid #E3F0E7;
        min-height: 104px;
        box-shadow: 0 6px 20px rgba(15,46,74,0.08);
        overflow: hidden;
    }
    .kpi-card::before {
        content: "";
        ...
        width: 6px;
        height: 100%;
        background: linear-gradient(180deg, #DA251D 0%, #FFCD00 100%);
    ...
    .kpi-index {
        ...
        background: linear-gradient(135deg, #0F2E4A, #1B4F72);
        display: flex;
        align-items: center;
        justify-content: center;
        font-family: \'Sora\', sans-serif;
    ...
    /* ===== Nhan dan tren KPI — tron, mau co do-vang ===== */
    .kpi-badge {
        position: absolute;
        top: 10px;
        right: 10px;
    ...
    .kpi-badge-moi { background: #163E5C; }
    .kpi-badge-quantrong { background: #DA251D; }
    .kpi-badge-dat { background: #1B4F72; }
    .kpi-badge-canluuy { background: #FFCD00; color: #5C4400; }
    .kpi-badge-info { background: #0F2E4A; }
    ...
    div[data-testid="stMetricValue"] { color: #0F2E4A !important; font-family: \'Sora\', sans-serif !important; }
    div[data-testid="stDataFrame"] { border-radius: 16px; overflow: hidden; border: 1px solid #E3F0E7; }
    </style>
    """,
...
def inject_background_images() -> None:
    ...
    st.markdown(
        ...
        <style>
        /* ==========================================================
           AIDEOM-VN — VIET NAM TU NHIEN / CONG NGHE THEME
           ========================================================== */

        :root {{
            --aideom-bg: #FFFDF7;
            --aideom-surface: #FFFFFF;
            --aideom-surface-strong: #FFFFFF;
            --aideom-border: #E3F0E7;
            --aideom-text: #1A2E22;
            --aideom-muted: #6B7280;
            --aideom-soft: #9CA3AF;
            --aideom-green: #0F2E4A;
        ...
        /* ===== Nen tong the ===== */
        .stApp {{
            background: linear-gradient(160deg, #FFFDF7 0%, #F0FBF4 55%, #FFF6F0 100%) !important;
        ...
        .stApp::before {{
            ...
            z-index: 0;
            background:
                radial-gradient(circle at 10% 8%, rgba(255,205,0,0.10), transparent 30%),
                radial-gradient(circle at 92% 85%, rgba(218,37,29,0.06), transparent 32%),
                radial-gradient(circle at 85% 12%, rgba(18,138,78,0.08), transparent 28%);
        }}
        ...
        .stAppHeader {{
            ...
            border-bottom: 1px solid #E3F0E7 !important;
        }}
        ...
        /* ===== Sidebar — xanh la quoc ky, dieu huong dang the ===== */
        section[data-testid="stSidebar"],
        [data-testid="stSidebar"] {{
            background: linear-gradient(180deg, #0F2E4A 0%, #163E5C 100%) !important;
        ...
        [data-testid="stSidebar"] [role="radiogroup"] label:hover {{
            background: rgba(255,205,0,0.18) !important;
        ...
        .hero {{
            ...
            background: linear-gradient(125deg, #0F2E4A 0%, #1B4F72 60%, #163E5C 100%) !important;
            border: none !important;
            box-shadow: 0 14px 40px rgba(15,46,74,0.25) !important;
        ...
        .aideom-hero {{
            background: linear-gradient(125deg, #0F2E4A 0%, #1B4F72 60%, #163E5C 100%) !important;
            border: none !important;
            box-shadow: 0 14px 50px rgba(15,46,74,0.28) !important;
            border-radius: 28px !important;
        }}
        ...
        .aideom-level-card, .aideom-feature-card, .aideom-data-card {{
            ...
            box-shadow: 0 6px 20px rgba(15,46,74,0.08) !important;
            backdrop-filter: none !important;
        }}
        ...
        details[data-testid="stExpander"] {{
            ...
            box-shadow: 0 6px 18px rgba(15,46,74,0.06) !important;
        }}
        ...
        button[data-baseweb="tab"][aria-selected="true"] {{
            background: linear-gradient(120deg, #0F2E4A, #1B4F72) !important;
            color: #FFFFFF !important;
        ...
        div[data-testid="stTable"] {{
            ...
            border-radius: 18px !important;
            overflow: hidden !important;
            box-shadow: 0 6px 20px rgba(15,46,74,0.06) !important;
        }}
        ...
        div[data-testid="stDataFrame"] {{
            ...
            --gdg-bg-cell-medium: #F0FBF4 !important;
            --gdg-bg-header: #0F2E4A !important;
            --gdg-text-dark: #1A2E22 !important;
            --gdg-text-medium: #4B5563 !important;
            --gdg-text-light: #6B7280 !important;
            --gdg-accent-color: #FFCD00 !important;
            --gdg-border-color: #E3F0E7 !important;
            --gdg-header-fg-color: #FFFFFF !important;
        }}
        ...
        .aideom-table-wrap {{
            ...
            border-radius: 18px;
            border: 1px solid #E3F0E7;
            box-shadow: 0 6px 20px rgba(15,46,74,0.06);
            background: #FFFFFF;
        }}
        ...
        .aideom-table-wrap tbody th {{
            ...
            border-bottom: 1px solid #F0FBF4 !important;
        ...
        .stButton button {{
            border-radius: 999px !important;
            border: none !important;
            background: linear-gradient(120deg, #DA251D, #FFCD00) !important;
            color: #FFFFFF !important;
            font-weight: 800 !important;
            font-family: 'Sora', sans-serif !important;
        }}
        ...
        .stButton button:hover {{
            background: linear-gradient(120deg, #0F2E4A, #1B4F72) !important;
            color: #FFFFFF !important;
            box-shadow: 0 6px 18px rgba(15,46,74,0.25) !important;
        }}
        ...
        try:
            ...
            styler = styler.set_table_styles(
                [
                    ...
                    {"selector": "td", "props": [("color", "#1A2E22")]},
                ],
                overwrite=False,
            )
        except Exception:
...
def _aideom_plotly_chart(fig, *args, **kwargs):
    """Apply a uniform light, navy/gold chart container to all Plotly figures."""
    try:
        fig.update_layout(
            paper_bgcolor="rgba(255, 255, 255, 0.0)",
            plot_bgcolor="rgba(240, 248, 255, 0.45)",
            font=dict(color="#1A2E22", family="Roboto, system-ui, sans-serif", size=13),
            title=dict(font=dict(color="#0F2E4A", size=18)),
            legend=dict(
                bgcolor="rgba(255, 255, 255, 0.90)",
                bordercolor="rgba(15, 46, 74, 0.18)",
                borderwidth=1,
            ),
            colorway=["#0F2E4A", "#1B4F72", "#FFCD00", "#DA251D", "#163E5C", "#6B9BD1"],
            margin=dict(l=14, r=14, t=56, b=18),
        )
        fig.update_xaxes(
            gridcolor="rgba(15, 46, 74, 0.10)",
            zerolinecolor="rgba(15, 46, 74, 0.18)",
            linecolor="rgba(15, 46, 74, 0.20)",
        )
        fig.update_yaxes(
            gridcolor="rgba(15, 46, 74, 0.10)",
            zerolinecolor="rgba(15, 46, 74, 0.18)",
...
def hero(title, subtitle, tags=None, tag_mark=""):
    tags = tags or []
    tag_html = "".join([f"<span class='pill'>{t}</span>" for t in tags])
    mark = tag_mark or (title.split()[0] if title else "")
    st.markdown(
        f"""
        <div class="hero" data-tag="{mark}">
...
def _kpi_badge(label, value, note):
    """Auto-detect a special badge based on label/value/note keywords."""
    text = f"{label} {value} {note}".lower()
    if "đạt" in text or "hoàn thành" in text or "pass" in text.lower():
        return "ĐẠT", "kpi-badge-dat"
    if "không vượt" in text or "cảnh báo" in text or "rủi ro" in text:
        return "CẦN LƯU Ý", "kpi-badge-canluuy"
    if "mới" in text or "2026" in text:
        return "MỚI", "kpi-badge-moi"
    if "quan trọng" in text or "ngân sách" in text or "tổng" in text:
        return "QUAN TRỌNG", "kpi-badge-quantrong"
    return None, None


def kpi_cards(items):
    cols = st.columns(len(items))
    for idx, (col, item) in enumerate(zip(cols, items), start=1):
        if len(item) == 4:
            label, value, note, badge = item
            badge_class = "kpi-badge-info"
        else:
            label, value, note = item
            badge, badge_class = _kpi_badge(label, value, note)
        with col:
            badge_html = (
                f'<div class="kpi-badge {badge_class}">{badge}</div>'
                if badge else ""
            )
            st.markdown(
                f"""
                <div class="kpi-card">
                    {badge_html}
                    <div class="kpi-index">{idx:02d}</div>
                    <div class="kpi-body">
