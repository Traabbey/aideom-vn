...
st.markdown(
    """
    <style>
    @import url(\'https://fonts.googleapis.com/css2?family=Merriweather:wght@400;700;900&family=Source+Serif+4:opsz,wght@8..60,400;8..60,600;8..60,700&family=Roboto:wght@300;400;500;700;900&display=swap\');
    .stApp {
        background: #F7F4EC;
        color: #1F2933;
    ...
    [data-testid="stSidebar"] {
        background: #0B2545;
        border-right: 3px double #B8860B;
    }
    h1, h2, h3, h4, h5 {
        letter-spacing: 0;
        color: #0B2545 !important;
        font-family: \'Merriweather\', \'Source Serif 4\', serif;
    }
    h1 { font-size: 2.0rem !important; font-weight: 900 !important; }
    h2 { font-size: 1.45rem !important; font-weight: 700 !important; }
    h3 { font-size: 1.12rem !important; font-weight: 700 !important; }
    p, li, label, span, div { font-family: \'Roboto\', sans-serif; }
    ...
    .hero {
        ...
        border-bottom: 6px solid #7A1F2B;
        background: #FFFFFF;
    ...
    /* ===== KPI card kiểu "chỉ số thống kê chính thức" ===== */
    .kpi-card {
        position: relative;
    ...
    /* ===== Nhãn dán (badges) trên KPI - kiểu dấu mộc ===== */
    .kpi-badge {
        position: absolute;
        top: 8px;
        right: 8px;
    ...
    .kpi-badge-moi { color: #0B2545; }
    .kpi-badge-quantrong { color: #7A1F2B; }
    .kpi-badge-dat { color: #1F7A3D; }
    .kpi-badge-canluuy { color: #B8860B; }
    .kpi-badge-info { color: #4B5563; }
    ...
    div[data-testid="stMetricValue"] { color: #0B2545 !important; font-family: \'Merriweather\', serif !important; }
    div[data-testid="stDataFrame"] { border-radius: 2px; overflow: hidden; border: 1px solid #C9BFA8; }
    </style>
    """,
...
def inject_background_images() -> None:
    ...
    st.markdown(
        ...
        <style>
        /* ==========================================================
           AIDEOM-VN — BAO CAO CHINH PHU / HOC THUAT THEME
           ========================================================== */
        ...
        :root {{
            ...
            --aideom-border: #C9BFA8;
            --aideom-text: #1F2933;
            --aideom-muted: #6B7280;
            --aideom-soft: #9CA3AF;
            --aideom-navy: #0B2545;
            --aideom-maroon: #7A1F2B;
            --aideom-gold: #B8860B;
            --aideom-green: #1F7A3D;
            --aideom-cyan: #0B2545;
            --aideom-pink: #7A1F2B;
        ...
        .stApp::before {{
            ...
            z-index: 0;
            background-image:
                repeating-linear-gradient(0deg, rgba(11,37,69,0.015) 0px, rgba(11,37,69,0.015) 1px, transparent 1px, transparent 64px),
                repeating-linear-gradient(90deg, rgba(11,37,69,0.015) 0px, rgba(11,37,69,0.015) 1px, transparent 1px, transparent 64px);
        }}
        ...
        /* ===== Sidebar — nen xanh nuoc bien dam, kieu trang trong ===== */
        section[data-testid="stSidebar"],
        [data-testid="stSidebar"] {{
            background: #0B2545 !important;
            border-right: 3px double #B8860B !important;
        }}
        ...
        .hero {{
            ...
            border-top: 6px solid #0B2545 !important;
            border-bottom: 6px solid #7A1F2B !important;
            box-shadow: 0 2px 10px rgba(11,37,69,0.08) !important;
        ...
        /* Trang chu hero (dark) -> chuyen sang xanh nuoc bien trang trong */
        .aideom-hero {{
            background: #0B2545 !important;
            border: 1px solid #0B2545 !important;
            border-top: 6px solid #B8860B !important;
            border-bottom: 6px solid #7A1F2B !important;
            box-shadow: 0 4px 18px rgba(11,37,69,0.25) !important;
            border-radius: 2px !important;
        }}
        ...
        div[data-testid="stDataFrame"] {{
            ...
            --gdg-bg-cell-medium: #F7F4EC !important;
            --gdg-bg-header: #0B2545 !important;
            --gdg-text-dark: #1F2933 !important;
            --gdg-text-medium: #4B5563 !important;
            --gdg-text-light: #6B7280 !important;
            --gdg-accent-color: #B8860B !important;
            --gdg-border-color: #C9BFA8 !important;
        ...
        .aideom-table-wrap tbody th {{
            ...
            border-bottom: 1px solid #E4DCC8 !important;
...
def hero(title, subtitle, tags=None, tag_mark=""):
    ...
    # short watermark text derived from the title (e.g. first word or custom tag_mark)
