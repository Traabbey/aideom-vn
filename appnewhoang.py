...
st.markdown(
    ...
    [data-testid="stSidebar"] {
        background: linear-gradient(180deg, #0B5D34 0%, #0E7A45 100%);
        border-right: none;
    }
    h1, h2, h3, h4, h5 {
    ...
    .hero {
        ...
        padding: 30px 38px;
        border-radius: 28px;
        background: linear-gradient(125deg, #0B5D34 0%, #128A4E 60%, #0E7A45 100%);
        box-shadow: 0 14px 40px rgba(11,93,52,0.25);
        margin-bottom: 22px;
        overflow: hidden;
        isolation: isolate;
    }
    ...
    .section-heading {
        ...
        background: linear-gradient(90deg, #0B5D34 0%, #128A4E 100%);
        box-shadow: 0 4px 14px rgba(11,93,52,0.18);
    }
    .section-heading .num {
        font-family: \'Sora\', sans-serif;
        font-size: 13px;
    ...
    /* ===== Card chung — bo tron mem, vien mau xanh nhat ===== */
    .section-card {
        padding: 20px 22px;
        border-radius: 22px;
        background: #FFFFFF;
        border: 1px solid #E3F0E7;
        box-shadow: 0 6px 24px rgba(11,93,52,0.07);
        margin-bottom: 16px;
    }
    ...
    .kpi-card {
        ...
        border: 1px solid #E3F0E7;
        min-height: 100px;
        box-shadow: 0 6px 20px rgba(11,93,52,0.08);
        overflow: hidden;
    }
    .kpi-card::before {
        content: "";
    ...
    .kpi-index {
        ...
        height: 44px;
        border-radius: 14px;
        background: linear-gradient(135deg, #0B5D34, #128A4E);
        display: flex;
        align-items: center;
        justify-content: center;
        font-family: \'Sora\', sans-serif;
    ...
    .kpi-badge-moi { background: #0E7A45; }
    .kpi-badge-quantrong { background: #DA251D; }
    .kpi-badge-dat { background: #128A4E; }
    .kpi-badge-canluuy { background: #FFCD00; color: #5C4400; }
    .kpi-badge-info { background: #0B5D34; }
    ...
    .success-box {
        padding: 14px 18px;
        border-left: 4px solid #128A4E;
        background: #EAFBF1;
        border-radius: 14px;
        margin: 12px 0;
    }
    div[data-testid="stMetricValue"] { color: #0B5D34 !important; font-family: \'Sora\', sans-serif !important; }
...
def inject_background_images() -> None:
    ...
    st.markdown(
        ...
        [data-testid="stSidebar"] {{
            background: linear-gradient(180deg, #0B5D34 0%, #0E7A45 100%) !important;
        ...
        .hero {{
            ...
            background: linear-gradient(125deg, #0B5D34 0%, #128A4E 60%, #0E7A45 100%) !important;
            border: none !important;
            box-shadow: 0 14px 40px rgba(11,93,52,0.25) !important;
        ...
        .aideom-hero {{
            background: linear-gradient(125deg, #0B5D34 0%, #128A4E 60%, #0E7A45 100%) !important;
            border: none !important;
            box-shadow: 0 14px 50px rgba(11,93,52,0.28) !important;
            border-radius: 28px !important;
        }}
        ...
        .aideom-level-card, .aideom-feature-card, .aideom-data-card {{
            ...
            box-shadow: 0 6px 20px rgba(11,93,52,0.08) !important;
            backdrop-filter: none !important;
        }}
        ...
        details[data-testid="stExpander"] {{
            ...
            box-shadow: 0 6px 18px rgba(11,93,52,0.06) !important;
        }}
        ...
        button[data-baseweb="tab"][aria-selected="true"] {{
            background: linear-gradient(120deg, #0B5D34, #128A4E) !important;
            color: #FFFFFF !important;
        ...
        div[data-testid="stTable"] {{
            ...
            border-radius: 18px !important;
            overflow: hidden !important;
            box-shadow: 0 6px 20px rgba(11,93,52,0.06) !important;
        }}
        ...
        div[data-testid="stDataFrame"] {{
            ...
            --gdg-bg-header: #0B5D34 !important;
        ...
        .aideom-table-wrap {{
            ...
            border-radius: 18px;
            border: 1px solid #E3F0E7;
            box-shadow: 0 6px 20px rgba(11,93,52,0.06);
            background: #FFFFFF;
        }}
        ...
        .stButton button:hover {{
            background: linear-gradient(120deg, #0B5D34, #128A4E) !important;
            color: #FFFFFF !important;
            box-shadow: 0 6px 18px rgba(11,93,52,0.25) !important;
        }}
...
def _aideom_plotly_chart(fig, *args, **kwargs):
    ...
    try:
        fig.update_layout(
            ...
            font=dict(color="#1E1B2E", family="Roboto, system-ui, sans-serif", size=13),
